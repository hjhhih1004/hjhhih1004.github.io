...
<link rel="stylesheet" href="http://hjhhih1004.github.io/html5/sample.css"/>
<title>CSS객체 선택 실습</title></head>
...
<section id="Area"><form id="id_form">
  ...
  <div id="div3">
    <label id="id32" for="id32">전화</label>
    <%= request.getParameter("sPhone")%>
  </div>
  <div id="div4">
<footer><p>&copy; 2021 Made by Korea. All rights reserved.</p></footer></body></html>
